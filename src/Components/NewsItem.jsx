  ...
  return (
    <div className="card bg-dark text-light mb-3 d-inline-block my-3 mx-4 px-2 py-2" style={{ maxWidth: "345px" }}>
      ...
      <div className="card-body">
        ...
        <p className="card-text">{description?description.slice(0,90):"News is a report of a current event. it is information about something that has just occurred"}</p>
